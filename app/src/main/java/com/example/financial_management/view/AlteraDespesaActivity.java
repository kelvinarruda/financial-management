...
public class AlteraDespesaActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_altera_despesa);
    ...
    public void btnAlteraDespesa(View view) {
    }
}